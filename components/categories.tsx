...
const Categories = () => {
    return (
        <div className="px-6 pt-10 pb-16 bg-background">
            <div className="mx-auto w-full max-w-(--breakpoint-xl)">
                ...
                <p className="mt-3 text-pretty text-muted-foreground text-sm tracking-[-0.01em] sm:text-center md:text-base">
                        ...
                        <Link href="#" key={index}>
                            <div className=" flex flex-col md:flex-row  md:max-w-lg items-start md:items-center gap-2 rounded-lg sm:mx-0 group">
                                <div className="aspect-square w-full md:w-auto md:h-24 shrink-0 overflow-hidden rounded-lg border border-border/20 bg-muted flex justify-center items-center">
                                    {<category.icon className="w-1/2 h-1/2 text-muted-foreground group-hover:text-primary" />}
                                </div>
